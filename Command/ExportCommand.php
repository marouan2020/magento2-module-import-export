...
use MageTunisia\ConfigImportExport\Model\Processor\ExportProcessorInterface;
...
class ExportCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \MageTunisia\ConfigImportExport\Model\File\Writer\WriterInterface $writer */
