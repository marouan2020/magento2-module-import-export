...
namespace MageTunisia\ConfigImportExport\Command;
...
use MageTunisia\ConfigImportExport\Model\Processor\ImportProcessorInterface;
 ...
 * Class ImportCommand
 *
 * @package MageTunisia\ConfigImportExport\Command
 */
class ImportCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \MageTunisia\ConfigImportExport\Model\File\Reader\ReaderInterface $reader */
