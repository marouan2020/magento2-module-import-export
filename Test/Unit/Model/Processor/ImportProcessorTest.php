...
namespace MageTunisia\ConfigImportExport\Test\Unit\Model\Processor;

use Magento\Framework\App\Config\Storage\WriterInterface;
use MageTunisia\ConfigImportExport\Model\Converter\ScopeConverterInterface;
use MageTunisia\ConfigImportExport\Model\Processor\ImportProcessor;
use MageTunisia\ConfigImportExport\Model\Validator\ScopeValidatorInterface;
use Symfony\Component\Console\Output\OutputInterface;

/**
 * Class ImportProcessorTest
 *
 * @package MageTunisia\ConfigImportExport\Test\Unit\Model\Processor
 */
class ImportProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $finderMock = $this->getMockBuilder('MageTunisia\ConfigImportExport\Model\File\Finder')
            ->setMethods(['find'])
            ->getMock();
        $finderMock
            ->expects($this->once())
    ...
    public function processWithInvalidScopeData()
    {
        ...
        $readerMock = $this->getMockBuilder('MageTunisia\ConfigImportExport\Model\File\Reader\YamlReader')
            ->setMethods(['parse'])
            ->getMock();
